...
st.sidebar.image('https://res.cloudinary.com/vistaprint/images/c_scale,w_448,h_299,dpr_2/f_auto,q_auto/v1705414606/ideas-and-advice-prod/en-us/900px-Olympic_flag.svg_/900px-Olympic_flag.svg_.png?_i=AA')
...
if user_menu == 'Country-Wise Analysis':
   ...
   t_df = helper.most_successful_countrywise(df, selected_country)
   st.table(t_df)
